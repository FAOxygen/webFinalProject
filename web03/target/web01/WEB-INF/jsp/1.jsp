...
<div class="wow fadeInUp">
    <img src="../images/76.png" class="img-responsive center-block container">

    <div class="xqy">
        <img src="../images/50.png" alt="Profile Image" class="profile-image">
        <div class="profile-info">
            ...
            <hr>
            <p>
                RMB 125/月 (0% 费率 24 个月分期) 起或 RMB 2999 起
            ...
            <p>
                颜色 - 彩虹版
                橄榄色晴空蓝色亮橙色午夜色星光色彩虹版白色红色
                了解更多表带类型，尝试不同表壳材质。Apple Watch 定制坊让你充分展现个人风格。Apple 独家提供。
            </p>
            <hr>
            <p>
                数量:
    ...
    <img src="../images/75.png" class="img-responsive center-block container">
    <!-- fotter -->
